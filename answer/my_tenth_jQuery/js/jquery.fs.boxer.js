...
$(function(){var c=$(".b-search-form__submit-btn"),f=$(".b-search-form__keyword"),b=$(".b-movie-list"),a=6,d=0,e=undefined;c.on("click",function(h){h.preventDefault();var g=f.val();if(g==""){return false}else{if(g!=e){b.empty();d=0}}var i=(d*a)+1;$.ajax({url:"http://gdata.youtube.com/feeds/api/videos",data:{alt:"json",vq:g,"max-results":a,"start-index":i}}).done(function(l){var k=l.feed.entry,j="";$.each(k,function(o,p){var q=p.title.$t,n=p.media$group.media$thumbnail[1].url,m=p.media$group.media$content[0].url.replace("/v/","/embed/");j+="<li class='js-movie-list__item b-movie-list__item'><a class='boxer' href='"+m+"' data-gallery='video_gallery'><img src='"+n+"' alt='"+q+"の動画'></a><a class='boxer' href='"+m+"' data-gallery='video_gallery'>"+q+"</a></li>"});b.prepend(j);c.val("もっと");e=g;d++;$(".boxer").boxer()}).fail(function(j,l,k){console.log("XMLHttpRequest : "+j.status);console.log("textStatus : "+l);console.log("errorThrown : "+k.message)})});f.focus(function(){c.val("検索")})});